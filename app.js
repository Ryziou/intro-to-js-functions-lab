...
function isCharAVowel(vowelTester) {
  const vowels = "aeiou"
  if (vowels.includes(vowelTester)) {
    return true
  } else {
    return false
  }
...
function createUsername(firstname, lastname) {
  ...
  let createUsername1 = firstname + lastname;
  return first + last + createUsername1.replace(" ", "").length;
}
...
function numArgs(num1, num2, num3, num4) {
  const numArgs1 = [1, 2, 3, 4]
  return numArgs1.length
}
